...
// ==================== Video / Cover Image Upload ====================
    private final By chooseVideo = By.xpath("//span[normalize-space()='Choose Video']");
    private final By videoFileInput = By.xpath("//input[@type='file' and not(@accept='image/*')]");
    private final By coverImage = By.xpath("//span[normalize-space()='Cover Image']");
...
//    private final By applicableDropdown = By.xpath("//*[normalize-space()='Applicable']//following::div[contains(@class,'common-select-content')][1]");
...
//    private final By activityTextEditor = By.xpath("(//div[@contenteditable='true' and contains(@class,'ql-editor')])[1]");
    ...
    public ContentPage(WebDriver driver) { this.driver = driver; this.commonActions = new CommonActions(driver); }
    ...
    public boolean isSubjectsDisplayed() { return commonActions.isDisplayed(subjectsPage); }
    ...
    public void addNewChapter(String subjectName, String grade, String chapterNumber, String chapterTitle, String chapterDescription, String videoPath, String imagePath, String content, String outcome1, String outcome2, String outcome3, String triviaQuestionData, String triviaOptionAData, String triviaOptionBData, String triviaOptionCData, String triviaOptionDData, String triviaContentData) throws InterruptedException, AWTException {
      ...
      //  commonActions.sleepThreeSeconds();
        Thread.sleep(6000);
        logger.info("Starting video upload: {}", videoPath);
       ...
       // commonActions.sleepThreeSeconds();
        logger.info("Video upload completed: {}", videoPath);
       // commonActions.sleepThreeSeconds();
        logger.info("Starting cover image upload: {}", imagePath);
        commonActions.logFileInputs();
        commonActions.uploadFile(coverImageFileInput, uploadedImage, null, imagePath);
        logger.info("Cover image upload completed: {}", imagePath);
        commonActions.sleepThreeSeconds();
        WebElement editor = commonActions.getElement(chapterContent);
    ...
    public void addQuizQuestion(String subjectName, String grade, String question, String option1Data, String option2Data, String option3Data, String option4Data, String explanation) {
        ...
        commonActions.isDisplayed(addQuestionTitle);
        ...
        WebElement difficultyElement = commonActions.getElement(difficultyLevelDropdown);
        commonActions.scrollToElement(difficultyElement);
        ...
        WebElement submitElement = commonActions.getElement(submitQuestionButton);
        commonActions.scrollToElement(submitElement);
    ...
    public void addTriviaQuestion(String question, String optionA, String optionB, String optionC, String optionD, String triviaContentData) {
        ...
        WebElement textButtonElement = commonActions.getElement(textButton);
        commonActions.scrollToElement(textButtonElement);
        commonActions.click(textButton);
        commonActions.sleepThreeSeconds();
        WebElement editor = commonActions.getElement(triviaContent);
        commonActions.scrollToElement(editor);
        editor.click();
